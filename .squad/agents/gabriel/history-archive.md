...
**Files:** `docs/crucible-technical-design/17-observability-telemetry.md` (10066B), `docs/crucible-technical-design/18-security-permissions.md` (11954B). Decision drop: (decision inbox drop — local-only).
...
**Deliverable:** (decision inbox drop — local-only)
...
**Output:** (decision inbox drop — local-only) (full survey + survival matrix + safety matrix + operational topology + hybrid trajectory + verdict + tags).
