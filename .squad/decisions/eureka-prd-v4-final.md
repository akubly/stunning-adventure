...
**Status:** Canonical, shippable. Supersedes PRD v3 + v3.1 patch set. **This is the v4-final revision-2 pass (post-Aaron-R7-finalization + post-Squad-panel + post-persona-review Design Panel).**
