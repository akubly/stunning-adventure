...
|---|-------|--------------------|------------|--------|--------|
| **ADR-0002** | L1 WAL Substrate Selection | Adopt Roger's A.3 hybrid — SQLite-WAL append log + per-record CBOR payload + BLAKE3 chain — as the single L1 substrate. | §3 | Roger | Accepted (CTD-locked) — [body authored](../adr/0002-l1-wal-substrate.md) |
...
| **ADR-0006** | Router as Single Policy Choke-Point | The Router is the sole place where trust-tier, capability, and approval policy is enforced; generators, applier, and SDK never decide policy. | §5 | Gabriel | Accepted (CTD-locked) — [body authored](../adr/0006-router-policy-chokepoint.md) |
